...
orix is a community maintained project.
We welcome contributions in the form of bug reports, feature requests, code,
documentation, and more.
The source code is hosted `on GitHub <https://github.com/pyxem/orix>`__.
These guidelines provide resources on how best to contribute.
...
Feel free to `ask a question <https://github.com/pyxem/orix/discussions>`__,
`open an issue <https://github.com/pyxem/orix/issues>`__ or `make a pull request
