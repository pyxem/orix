...
def test_pole_density_function_symmetry(point_groups):
    pg = point_groups
    v = Vector3d(np.random.randn(10_000, 3)).unit
...
def test_pole_density_function_hemisphere():
...
def test_pole_density_function_values(n):
...
def test_pole_density_function_log():
    v = Vector3d(np.random.randn(11_234, 3)).unit
...
def test_pole_density_function_sigma():
    v = Vector3d(np.random.randn(11_234, 3)).unit
