...
class TestAngReader:
    ...
    def test_get_phases_from_header(
        ...
        def test_phasename_autogen(self):
            # using some stripped down headers, test different combinations
            # for expected autogenerated phase names.
            # NOTE: this is NOT intended to test if headers are properly
            # parsed, only that a properly parsed header will produce the
            # expected phase names.

            phaselist_data = [
                {
                    "ids": [1, 2],
                    "names": ["Ti_alpha", "Ti_beta"],
                    "point_groups": ["62", "43"],
                },
                {
                    "ids": [2, 1],
                    "names": ["Ti_beta", "Ti_alpha"],
                    "point_groups": ["43", "62"],
                },
                {
                    "ids": [1, 2, 3],
                    "names": ["Ti alpha", "Ti beta", "Ti beta 2"],
                    "point_groups": ["43", "62", "62"],
                },
                {
                    "ids": [1, 2],
                    "names": ["Ti", "Fe"],
                ...
                {
                    "ids": [1, 2, 5, 4, 3],
                    "names": ["TiA", "TiB", "ferrite", "Fe3C", "unobtanium"],
                    "point_groups": ["43", "62", "43", "mmm", "1"],
                },
                {
                    "ids": [1, 2, 5, 4, 3],
                    "names": ["TiA", "TiB", "ferrite", "Fe3C", "unobtanium"],
            ...
            expectations = [
                ["Ti-622", "Ti-432"],
                ["Ti-622", "Ti-432"],
                ["Ti-432-A", "Ti-622-B", "Ti-622-C"],
                ["Ti", "Fe"],
                ["Ti-432", "Ti-622", "XX-1", "FeC-mmm", "Fe-432"],
                ["TiA", "TiB", "unobtanium", "Fe3C", "ferrite"],
            ]

            for plg, fm, expect in zip(phaselist_data, formulas, expectations):
                pl = PhaseList(**plg)
                _autogen_phase_names(pl, fm, plg["ids"])
                assert pl.names == expect
