...
def test_object3d(request):
    ...
    class TestObject3dClass(Object3d):
        dim = request.param

    return TestObject3dClass
...
class TestObject3d:
    ...
    def test_init(self, test_object3d, data):
    ...
    def test_init_fails(self, test_object3d, data):
    ...
    def test_slice(self, test_object3d, data, key):
        obj = test_object3d(data)
        obj_subset = obj[key]
    ...
    def test_unique(self, test_object3d):
    ...
    def test_get_random_sample(self, test_object3d):
